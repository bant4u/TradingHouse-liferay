...
/**
 * The persistence utility for the t h admin service. This utility wraps {@link THAdminPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class THAdminUtil {
	 ...
	 */
	public static void clearCache(THAdmin thAdmin) {
		getPersistence().clearCache(thAdmin);
	}
	 ...
	 */
	public static List<THAdmin> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<THAdmin> findWithDynamicQuery(
	 ...
	 */
	public static THAdmin update(THAdmin thAdmin, boolean merge)
		throws SystemException {
		return getPersistence().update(thAdmin, merge);
	}
	...
	public static THAdmin update(THAdmin thAdmin, boolean merge,
		...
		return getPersistence().update(thAdmin, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(thAdmin);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(thAdmins);
	}
	...
	*/
	public static com.lftechnology.bijaydemo.model.THAdmin create(long id) {
	...
	*/
	public static com.lftechnology.bijaydemo.model.THAdmin remove(long id)
		throws com.lftechnology.bijaydemo.NoSuchTHAdminException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(id);
	}

	public static com.lftechnology.bijaydemo.model.THAdmin updateImpl(
		com.lftechnology.bijaydemo.model.THAdmin thAdmin, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(thAdmin, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.bijaydemo.model.THAdmin findByPrimaryKey(
		long id)
		throws com.lftechnology.bijaydemo.NoSuchTHAdminException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.bijaydemo.model.THAdmin fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.lftechnology.bijaydemo.model.THAdmin> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static THAdminPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (THAdminPersistence)PortletBeanLocatorUtil.locate(com.lftechnology.bijaydemo.service.ClpSerializer.getServletContextName(),
					THAdminPersistence.class.getName());

			ReferenceRegistry.registerReference(THAdminUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(THAdminPersistence persistence) {
	}

	private static THAdminPersistence _persistence;
}